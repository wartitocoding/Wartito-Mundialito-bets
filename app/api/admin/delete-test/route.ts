...
/**
 * Borra SOLO cuentas de prueba (email que empieza con 'diagtest_') y sus
 * apuestas. Endpoint temporal para limpiar tests. No puede tocar cuentas
 * reales porque filtra por el prefijo de email de prueba.
 */
